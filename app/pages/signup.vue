      ...
      <div class="card">
        ...
        <template v-if="!success">
          ...
          <button
            ...
            :disabled="loading"
            class="w-full flex items-center justify-center gap-3 bg-white dark:bg-warm-700 border border-cream-200 dark:border-warm-600 rounded-2xl px-4 py-3 text-warm-700 dark:text-cream-100 hover:bg-cream-50 dark:hover:bg-warm-600 transition-all mb-4 disabled:opacity-50"
          >
          ...
          <form @submit.prevent="handleSignUp" class="space-y-4">
            ...
            <button
              type="submit"
              :disabled="loading"
              class="w-full btn-primary py-4 text-base disabled:opacity-50"
            >
              {{ loading ? '가입 중...' : '회원가입' }}
            </button>
          </form>
